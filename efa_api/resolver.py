"""
Except for this docstring, this file is a verbatim copy of resolver.py from the Connexion project, commit edb0381
https://github.com/spec-first/connexion/commit/edb0381af34ad2a35aab94569f503b85aa1ba964

It is included here because the Connexion didn't include all commits into the latest
published version (2.14.2)
